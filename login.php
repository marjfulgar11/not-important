...
<div id = "header">
    ...
    <tr>
    	<td width="80%" align="left"> <font size="12px">U</font><span style="font-size: 18px;">niversity <font size="12px">P</font><span style="font-size: 18px;">OS</span></td>
        <td width="10%">&nbsp;   </td>
...
<tr>
	<td>
    &copy; 2022 All Rights Reserved.  |  Designed By:<a href="https://www.facebook.com/jun.magayanes">GROUP 1</a>	
    </td>
</tr>
</table>
 </div>
